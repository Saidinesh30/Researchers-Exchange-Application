...
<script type="text/javascript" src="js/validate_number.js"></script>
    ...
    <body>
        ...
        <div id="header">
            <nav id="header_menu">
                <ul  class="left" >
                     <li><a class="maintitle" href="UserController?action=home">Researchers Exchange Participations</a></li>
                </ul>
                  <ul class="right">
